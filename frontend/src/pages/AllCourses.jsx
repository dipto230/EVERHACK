  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#030615] text-white flex">
      ...
      <motion.aside
        ...
        className="w-[260px] h-screen overflow-y-auto bg-black/60 backdrop-blur-xl fixed top-0 left-0 p-6 py-[130px] border-r border-cyan-400/20 shadow-[0_0_40px_rgba(0,255,255,0.3)] z-20"
      >
